...
def parse_policy(
    ...
    program: Annotated[str | None, typer.Option("--program", "-p", help="Program hint: snap|wic|medicaid|...")] = None,
    output: Annotated[Path | None, typer.Option("--output", "-o", help="Where to write threshold JSON")] = None,
